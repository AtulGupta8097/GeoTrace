...
fun createCircle(centerLat: Double, centerLng: Double, radiusMeters: Double, points: Int = 64): Polygon {
    ...
    val ring = (0 until points).map { i ->
        ...
        Point.fromLngLat(centerLng + degLng * cos(theta), centerLat + degLat * sin(theta))
    }.toMutableList()
