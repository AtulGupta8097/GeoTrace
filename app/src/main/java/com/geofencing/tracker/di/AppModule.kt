...
object AppModule {
    ...
    @Provides @Singleton
    fun provideGeofenceDao(database: GeofenceDatabase): GeofenceDao = database.geofenceDao()

    @Provides @Singleton
    fun provideVisitDao(database: GeofenceDatabase): VisitDao = database.visitDao()

    @Provides @Singleton
    fun provideGeofenceRepository(geofenceDao: GeofenceDao, visitDao: VisitDao): GeofenceRepository =
        GeofenceRepositoryImpl(geofenceDao, visitDao)
